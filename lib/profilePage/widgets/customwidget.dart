        ...
        tabs: [
          Container(
            ...
            child: Row(
              ...
              children: [const Icon(FeatherIcons.user),SizedBox(width: AppResponsive().screenWidth(context)*0.01), const Text("Pribadi")],
            ),
          ),
          Container(
            width: double.infinity,
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [const Icon(FeatherIcons.shoppingBag,),SizedBox(width: AppResponsive().screenWidth(context)*0.01), const Text("Penjualan")],
            ),
          ),
        ],
      ),
