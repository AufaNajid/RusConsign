...
class AppTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'Indonesia': {
          ...
          'tungguAdmin':
              'Menunggu persetujuan dari admin, ini mungkin akan butuh waktu untuk menyamakan data inputan anda dengan data yang ada di SMK RUS',
        ...
        'English': {
          ...
          'tungguAdmin':
              'Awaiting approval from the admin, this may take some time to match your input data with the data in SMK RUS',
